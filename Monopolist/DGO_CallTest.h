#ifndef CGalTest_DGO_CallTest_h
#define CGalTest_DGO_CallTest_h
...
// Seems pretty useless : one cannot change the sparsity pattern during optimization


#include "DGO_Traits.h"
#include "DGO_Test.h"
...
int dgo_main (int argc,char ** argv)
{
